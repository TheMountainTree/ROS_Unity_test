...
预处理: 坏道检测 → 去均值 → 去趋势 → 带通6-48Hz → 陷波50/100Hz → 降采样256Hz
"""
...
def prepare_data():
    """加载数据，检测坏道，预处理，返回 X, y, good_channels。"""
    data_path = "data/central_controller_ssvep_node4_test/ssvep4_pretrain_dataset_20260414_140753.npy"

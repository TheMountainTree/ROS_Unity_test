...
from .reasoner_1 import ReasonerModule
from .ssvep_communication_node3_config import make_default_config
from .utils import CircularEEGBuffer, NodeState, TrialState


class CentralControllerSSVEPNode3(DecodeModule, PretrainModule, ReasonerModule, Node):
    ...
    def __init__(self):
        ...
        self.get_logger().info(
            "CentralControllerSSVEPNode3 started: "
...
def main(args=None):
    ...
    node = CentralControllerSSVEPNode3()
    try:
        rclpy.spin(node)
